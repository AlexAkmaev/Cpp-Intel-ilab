...
void VulkanExample::prepareVertices(bool useStagingBuffers, std::vector<Vertex>& vertexBuffer)
{
	...
	//Yellow triangle in a position of light source
...
void VulkanExample::updateUniformBuffers()
{
	...
	uboVS.modelMatrix = glm::rotate(uboVS.modelMatrix, glm::radians(-rotation.x * 0.15f), glm::vec3(1.0f, 0.0f, 0.0f));
	uboVS.modelMatrix = glm::rotate(uboVS.modelMatrix, glm::radians(-rotation.y * 0.15f), glm::vec3(0.0f, 1.0f, 0.0f));
	uboVS.modelMatrix = glm::rotate(uboVS.modelMatrix, glm::radians(-rotation.z * 0.15f), glm::vec3(0.0f, 0.0f, 1.0f));
...
void VulkanExample::prepare(std::vector<VulkanExample::Vertex>& vertexBuffer)
{
	VulkanExampleBase::prepare();
	prepareSynchronizationPrimitives();
	prepareVertices(USE_STAGING, vertexBuffer);
...
int APIENTRY WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR pCmdLine, int nCmdShow)
{
	...
	std::vector<VulkanExample::Vertex> vertexBuffer;
	...
	vulkanExample->prepare(vertexBuffer);
